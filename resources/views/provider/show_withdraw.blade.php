                    ...
                    <div class="card-body">
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            <tr>
                                ...
                                <td width="50%">{{ $currency_icon->icon }}{{ $withdraw->total_amount - $withdraw->withdraw_amount }}</td>
                            </tr>

                            <tr>
                                <td width="50%">{{__('user.Total amount')}}</td>
                                <td width="50%">{{ $currency_icon->icon }}{{ $withdraw->total_amount }}</td>
                            </tr>
                            <tr>
                                <td width="50%">{{__('user.Withdraw amount')}}</td>
                                <td width="50%">{{ $currency_icon->icon }}{{ $withdraw->withdraw_amount }}</td>
                            </tr>
                            <tr>
