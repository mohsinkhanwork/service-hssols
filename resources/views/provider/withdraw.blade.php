                            ...
                            <tbody>
                                @foreach ($withdraws as $index => $withdraw)
                                    <tr>
                                        ...
                                        <td>{{ $currency_icon->icon }}{{ $withdraw->total_amount - $withdraw->withdraw_amount }}</td>
                                        <td>{{ $currency_icon->icon }}{{ $withdraw->total_amount }}</td>
                                        <td>{{ $currency_icon->icon }}{{ $withdraw->withdraw_amount }}</td>
                                        <td>
